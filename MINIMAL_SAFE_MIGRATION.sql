-- =====================================================
-- BARAKAH.SOCIAL - MINIMAL SAFE MIGRATION
-- =====================================================
-- This script creates only the essential tables safely
...
-- COMPLETION MESSAGE
-- =====================================================
SELECT 'Barakah.social minimal database setup completed successfully! 🎉' as status;
