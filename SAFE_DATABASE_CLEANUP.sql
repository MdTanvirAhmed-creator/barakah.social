-- =====================================================
-- BARAKAH.SOCIAL - SAFE DATABASE CLEANUP
-- =====================================================
-- This script safely cleans the database by handling existing types
-- =====================================================

-- =====================================================
-- SAFE CLEANUP - DROP TABLES FIRST
-- =====================================================
...
-- =====================================================
-- SAFE CLEANUP - DROP ENUMS WITH CASCADE
-- =====================================================

-- Drop all ENUMs with CASCADE to handle dependencies
...
-- =====================================================
-- SAFE CLEANUP - DROP FUNCTIONS AND TRIGGERS
-- =====================================================
...
-- =====================================================
-- SAFE CLEANUP - DROP EXTENSIONS (OPTIONAL)
-- =====================================================

-- Note: We keep extensions as they might be used by other parts of the system
...
-- COMPLETION MESSAGE
-- =====================================================
SELECT 'Database cleaned successfully! 🧹 All tables, types, and functions removed.' as status;
