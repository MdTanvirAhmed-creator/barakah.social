...
export default function SearchAnalyticsPage() {
  ...
  const mockAnalytics: SearchAnalytics = {
    ...
    searchTopics: [
      {
        ...
        trend: 'up',
        category: 'Fundamentals',
        relatedQueries: ['prayer', 'salah', 'fasting', 'hajj']
      },
      {
        topic: 'Fundamentals',
        searches: 3890,
        ...
        trend: 'up',
        category: 'Education',
        relatedQueries: ['five pillars', 'shahada', 'islamic basics']
      },
      {
        topic: 'Language',
        searches: 2340,
        ...
        trend: 'down',
        category: 'Education',
        relatedQueries: ['arabic', 'quranic', 'vocabulary']
      },
      {
        topic: 'Practical',
        searches: 1980,
        ...
        trend: 'up',
        category: 'Lifestyle',
        relatedQueries: ['halal', 'food', 'finance', 'business']
      }
    ],
    clickThroughRates: [
      {
    ...
    searchRefinements: [
      {
        originalQuery: 'prayer',
        refinedQuery: 'prayer times',
        count: 340,
        successRate: 0.85,
        commonRefinements: ['times', 'schedule', 'qibla']
      },
      {
        originalQuery: 'islam',
        refinedQuery: 'islamic fundamentals',
        count: 280,
        successRate: 0.78,
        commonRefinements: ['basics', 'fundamentals', 'principles']
      },
      {
        originalQuery: 'arabic',
        refinedQuery: 'quranic arabic',
        count: 220,
        successRate: 0.72,
        commonRefinements: ['quranic', 'classical', 'learning']
      }
    ],
    filterUsage: [
      {
    ...
    contentGaps: [
      {
        ...
        avgResults: 8,
        gapScore: 0.76,
        suggestedContent: ['Parenting in Islam', 'Raising Muslim Children', 'Islamic Family Values'],
        category: 'Family'
      },
      {
        query: 'islamic psychology',
        searches: 280,
        avgResults: 12,
        gapScore: 0.68,
        suggestedContent: ['Islamic Psychology', 'Mental Health in Islam', 'Spiritual Healing'],
        category: 'Health'
      },
      {
        query: 'islamic art',
        ...
        avgResults: 15,
        gapScore: 0.62,
        suggestedContent: ['Islamic Calligraphy', 'Geometric Patterns', 'Islamic Architecture'],
        category: 'Culture'
      }
    ],
    timeRange: '7d',
  ...
  useEffect(() => {
    ...
    const loadAnalytics = async () => {
      try {
        ...
        // Temporary: Use mock data for demonstration
