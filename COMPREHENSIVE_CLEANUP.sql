-- =====================================================
-- BARAKAH.SOCIAL - COMPREHENSIVE CLEANUP
-- =====================================================
-- This script performs comprehensive cleanup of ALL possible database objects
-- =====================================================

-- =====================================================
-- STEP 1: DROP ALL ENUMS (COMPREHENSIVE LIST)
-- =====================================================
...
DROP TYPE IF EXISTS study_group_type CASCADE;
DROP TYPE IF EXISTS verification_level CASCADE;
DROP TYPE IF EXISTS content_quality_level CASCADE;
DROP TYPE IF EXISTS recommendation_status CASCADE;

-- =====================================================
-- STEP 2: DROP ALL TABLES (COMPREHENSIVE LIST)
-- =====================================================
...
-- =====================================================
-- STEP 3: DROP ALL VIEWS (COMPREHENSIVE LIST)
-- =====================================================
...
-- =====================================================
-- STEP 4: DROP ALL FUNCTIONS (COMPREHENSIVE LIST)
-- =====================================================
...
DROP FUNCTION IF EXISTS update_learning_progress() CASCADE;

-- =====================================================
-- STEP 5: DROP ALL TRIGGERS (COMPREHENSIVE LIST)
-- =====================================================
...
DROP TRIGGER IF EXISTS update_user_stats_trigger ON profiles CASCADE;
DROP TRIGGER IF EXISTS update_content_stats_trigger ON posts CASCADE;
DROP TRIGGER IF EXISTS update_learning_progress_trigger ON learning_path_progress CASCADE;

-- =====================================================
-- STEP 6: DROP ALL INDEXES (COMPREHENSIVE LIST)
-- =====================================================
...
-- =====================================================
-- STEP 7: DROP ALL SEQUENCES (COMPREHENSIVE LIST)
-- =====================================================
...
-- =====================================================
-- STEP 8: DROP ALL DOMAINS (COMPREHENSIVE LIST)
-- =====================================================
...
DROP DOMAIN IF EXISTS uuid_string CASCADE;
DROP DOMAIN IF EXISTS timestamp_tz CASCADE;

-- =====================================================
-- COMPLETION MESSAGE
-- =====================================================
SELECT 'Comprehensive cleanup completed! 🧹 All database objects removed. Ready for fresh migrations.' as status;
