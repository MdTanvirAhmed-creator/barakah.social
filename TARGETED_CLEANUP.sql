-- =====================================================
-- BARAKAH.SOCIAL - TARGETED CLEANUP
-- =====================================================
-- This script targets the specific ENUM causing issues
-- =====================================================

-- =====================================================
-- STEP 1: DROP THE SPECIFIC ENUM CAUSING ISSUES
-- =====================================================

-- Drop the specific ENUM that's causing the "already exists" error
DROP TYPE IF EXISTS report_reason CASCADE;

-- =====================================================
-- STEP 2: DROP ALL OTHER POSSIBLE ENUMS
-- =====================================================

-- Drop all other possible ENUMs that might exist
...
-- COMPLETION MESSAGE
-- =====================================================
SELECT 'Targeted cleanup completed! 🧹 Specific ENUMs and objects removed. Ready for migration.' as status;
